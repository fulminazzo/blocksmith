...
import it.fulminazzo.blocksmith.command.visitor.tab.TabCompletionVisitor;
...
public abstract class CommandRegistry {
    ...
    private @NotNull Map<String, LiteralNode> getCommandNodes(final Object @NotNull ... commandModules) {
        ...
        for (Object commandModule : commandModules)
            nodes.addAll(CommandParser.parseCommands(commandModule, getSenderType(), getPrefix(), application.getExecutor()));
    ...
    /**
     * Gets the tab completions for the given input.
     *
     * @param command     the root of the command route
     * @param executor    the executor of the command
     * @param commandName the command name
     ...
     * @param command     the root of the command route
     */
    protected abstract void onRegister(final @NotNull String commandName, final @NotNull LiteralNode command);
