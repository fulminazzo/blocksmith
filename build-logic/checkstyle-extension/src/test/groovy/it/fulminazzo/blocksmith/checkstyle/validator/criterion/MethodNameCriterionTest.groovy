...
class MethodNameCriterionTest extends Specification {
    ...
    def 'test that #criterion returns #expected for #name and #message'() {
        ...
        // Getter and setter
        MethodNameCriterion.PAIRED | 'print'    || false | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'get'      || true  | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'is'       || true  | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'set'      || true  | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'equals'   || false | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'hashCode' || false | 'method.name.getterAndSetter'
        MethodNameCriterion.PAIRED | 'toString' || false | 'method.name.getterAndSetter'
        // Equals
