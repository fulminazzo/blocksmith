...
class MethodNameCriterionTest extends Specification {
    ...
    def 'test that #criterion returns #expected for #name and #message'() {
        ...
        // Getter and setter
        MethodNameCriterion.GETTER_AND_SETTER | 'print'    || false    | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'get'      || true     | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'is'       || true     | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'set'      || true     | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'equals'   || false    | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'hashCode' || false    | 'method.name.pairedMethods'
        MethodNameCriterion.GETTER_AND_SETTER | 'toString' || false    | 'method.name.pairedMethods'
        // Equals
