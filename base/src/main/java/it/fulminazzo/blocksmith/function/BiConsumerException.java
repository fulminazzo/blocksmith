...
/**
 * A function that takes two parameters but does not return anything.
 ...
 */
@FunctionalInterface
public interface BiConsumerException<F, S, X extends Exception> {
     ...
     */
    void accept(final F first, final S second) throws X;
