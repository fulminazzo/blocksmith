...
class RabbitMQMessageBrokerExceptionTest extends Specification {

    def 'test that getCauseMessage of #throwable returns #expected'() {
        when:
        def actual = RabbitMQMessageBrokerException.getCauseMessage(throwable)
    ...
    def 'test that unwrapCause of #throwable returns #expected'() {
        when:
        def actual = RabbitMQMessageBrokerException.unwrapCause(throwable)
