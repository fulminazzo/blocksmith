 ...
 * Example usage:
 * <pre>{@code
 * void function(@AlphabeticalOrDigit String code) {
 *     // code must only contain letters or digits (or null)
 * }
 * }</pre>
 *
 * @see Constraint
...
public @interface AlphabeticalOrDigit {
     ...
     * @return the message
     */
    @NotNull String exceptionMessage() default "'%1$s' is not allowed (only letters and digits)";
