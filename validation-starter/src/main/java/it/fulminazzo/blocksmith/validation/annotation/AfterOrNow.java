 ...
 * must be after or equal to the current time of execution (milliseconds are ignored).
 * <br>
 * Supported types are:
 * <ul>
 ...
 * Example usage:
 * <pre>{@code
 * void function(@AfterOrNow LocalDate date) {
 *     // date must be now or in the future (or null)
 * }
 * }</pre>
 *
 * @see Constraint
