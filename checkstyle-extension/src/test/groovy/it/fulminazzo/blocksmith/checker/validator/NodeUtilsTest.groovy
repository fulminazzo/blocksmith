...
class NodeUtilsTest extends Specification {
    ...
    def 'test that isModifierPresent works'() {
        ...
        expect:
        NodeUtils.isModifierPresent(node, TokenTypes.LITERAL_STATIC)
        NodeUtils.isModifierPresent(node, TokenTypes.FINAL)
        NodeUtils.isModifierPresent(node, TokenTypes.LITERAL_PUBLIC)
        !NodeUtils.isModifierPresent(node, TokenTypes.LITERAL_TRANSIENT)
    }
